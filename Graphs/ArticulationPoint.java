/* A vertex in undirected graph which when removed increases the components of graph
 * Tarjan Algorithm
 */
...
public class ArticulationPoint {
    ...
    public static void getAP(ArrayList<Edge> graph[], int V) {
        int dt[] = new int[V]; // Discovery time of vertex
        int low[] = new int[V]; // Lowest discovery time of neighbour vertex
        int time = 0;
